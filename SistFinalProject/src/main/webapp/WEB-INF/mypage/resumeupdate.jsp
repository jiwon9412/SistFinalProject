...
<!-- 상단 바 끝-->
			...
			<div class="container">
								...
								<td rowspan="5">
									<div class="resumephoto"
										...
										<input type="file" name="rphoto" id="rphoto"
											...
											src="${root}/images/${resumedto.photo}" id="photoo_preview"
											style="width: 117.8px; height: 157.8px;">
						...
						<div class="row">
							<div style="width: 180px; margin-left: 20px; margin-right: 20px;"
								...
								<c:forEach items="${license1}" var="li" varStatus="status">
									<input type="text" class="form-control" id="license1"
										name="license1" placeholder="어학시험/자격증 이름 입력" value="${li}"
										style="margin-bottom: 5px;">
								</c:forEach>
							</div>
							<div style="width: 160px; margin-right: 10px;" id="plus_license2">
								<label for="license">급수/점수</label>
								<c:forEach items="${license2}" var="li" varStatus="status">
									<input type="text" class="form-control" id="license2"
										name="license2" placeholder="급수/점수 입력" value="${li}"
										style="margin-bottom: 5px;">
								</c:forEach>
							</div>
							<div style="width: 160px;" id="plus_license3">
								<label for="license">취득월</label>
								<c:forEach items="${license3}" var="li" varStatus="status">
									<input type="month" class="form-control" id="license3"
										name="license3" placeholder="취득월 입력" value="${li}"
										style="margin-bottom: 5px;">
								</c:forEach>
							</div>
						</div>
				...
				<div class="row">
							...
							<div class="row">
								<div
									...
									<label for="highschool">고등학교 *</label> <input type="text"
										...
										placeholder="출신 고등학교 입력" value="${resumedto.highschool1}">
								</div>
								<div style="width: 160px; margin-right: 10px;">
									<label for="highschool">입학 *</label> <input type="month"
										class="form-control" id="highschool2" name="highschool2"
										placeholder="입학월" value="${resumedto.highschool2}">
								</div>
								<div style="width: 160px;">
									<label for="highschool">졸업 *</label> <input type="month"
										class="form-control" id="highschool3" name="highschool3"
										placeholder="졸업월" value="${resumedto.highschool3}">
								</div>
								<div
									...
									<label for="college">대학교 *</label> <input type="text"
										...
										placeholder="출신 대학교 입력" value="${resumedto.college1}">
								</div>
								<div style="width: 160px; margin-right: 10px; margin-top: 30px;">
									<label for="college">입학 *</label> <input type="month"
										class="form-control" id="college2" name="college2"
										placeholder="입학월" value="${resumedto.college2}">
								</div>
								<div style="width: 160px; margin-top: 30px;">
									<label for="college">졸업(예정) *</label> <input type="month"
										class="form-control" id="college3" name="college3"
										placeholder="졸업월" value="${resumedto.college3}">
								</div>
								<div style="margin-left: 20px; margin-right: 20px; margin-top: 30px;">
									<input type="hidden" id="resume_military" value="${resumedto.military}">
									<label for="military">병역 *</label>
									<select class="form-control military" id="military" name="military" style="height: 30px;">
							...
							<div style="width: 180px; margin-left: 20px; margin-right: 20px;"
								...
								<c:forEach items="${activity1}" var="li" varStatus="status">
									<input type="text" class="form-control" id="activity1"
										name="activity1" placeholder="대외활동명 입력" value="${li}"
										style="margin-bottom: 5px;">
								</c:forEach>
							</div>
							<div style="width: 160px; margin-right: 10px;"
								...
								<c:forEach items="${activity2}" var="li" varStatus="status">
									<input type="month" class="form-control" id="activity2"
										name="activity2" placeholder="시작" value="${li}"
										style="margin-bottom: 5px;">
								</c:forEach>
							</div>
							<div style="width: 160px;" id="plus_activity3">
								<label for="activity">종료일</label>
								<c:forEach items="${activity3}" var="li" varStatus="status">
									<input type="month" class="form-control" id="activity3"
										name="activity3" placeholder="종료" value="${li}"
										style="margin-bottom: 5px;">
								</c:forEach>
							</div>
						</div>
						...
						<div id="plus_hr">
							<div class="row" id="plus_career">
								<c:forEach items="${career1}" var="li" varStatus="status">
									<div
										style="width: 180px; margin-left: 20px; margin-right: 20px; margin-bottom: 15px;">
										<label for="career">회사명</label> <input type="text"
											class="form-control" id="career1" name="career1"
											placeholder="회사명" value="${li}">
									</div>
									<div style="width: 160px; margin-bottom: 15px;">
										<label for="career">부서명</label> <input type="text"
											...
											placeholder="부서명" value="${career2[status.index]}">
									</div>
									<div
										style="width: 180px; margin-left: 20px; margin-right: 20px;">
										<label for="career">직급/직책</label> <input type="text"
											class="form-control" id="career3" name="career3"
											placeholder="직급/직책" value="${career3[status.index]}">
									</div>
									<div style="width: 160px; margin-right: 10px;">
										<label for="career">입사월</label> <input type="month"
											class="form-control" id="career4" name="career4"
											placeholder="입사월" value="${career4[status.index]}">
									</div>
									<div style="width: 160px;">
										<label for="career">퇴사월</label> <input type="month"
											class="form-control" id="career5" name="career5"
											placeholder="퇴사월" value="${career5[status.index]}">
									</div>
									<div
						...
						<div class="rounded p-2 bg-light">
							<div class="media mb-2 border-bottom">
								<textarea class="form-control" id="introduce" name="introduce"
									style="height: 200px;">${resumedto.introduce}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6 col-lg-6 mb-3">
						...
						<div style="margin-left: 20px; margin-right: 20px; margin-top: 30px;">
							<input type="hidden" id="resume_job" value="${resumedto.job}">
							<select class="form-control job" id="job" name="job" style="height: 30px; width: 200px;">
					...
					<div class="col-sm-6 col-lg-6 mb-3">
						...
						<div class="mb-4">
							<input type="file" class="form-control" name="uploadportfolio"
								style="height: 40px;" value="${resumedto.uploadportfolio}">
						</div>
	...
	<script type='text/javascript'>
		...
		$(document).ready(function () {
			job_val = $('#resume_job').val();
			$('select.job option[value=' + job_val + ']').attr('selected', 'selected');
			military_val = $('#resume_military').val();
			//alert(job_val+","+military_val);
			$('select.military option[value=' + military_val + ']').attr('selected', 'selected');
		});
	</script>
</body>
</html>