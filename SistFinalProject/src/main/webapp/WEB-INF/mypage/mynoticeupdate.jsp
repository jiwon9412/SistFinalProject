                    ...
                    <div class="title-left">
						...
						<div class="row">
                                <div style="width: 100%; margin-left: 20px; margin-right: 20px;">
                                    ...
                                    <input type="text" class="form-control" id="subject" name="subject" placeholder="공고제목" value="${noticedto.subject}">
                                </div>
                                ...
                                <div style="width: 28.6%; margin-right: 20px; margin-top: 30px;">
                                    ...
                                    <input type="text" class="form-control" id="location" name="location" placeholder="지점" value="${noticedto.location}">
                                </div>
                                <div style="width: 28.6%; margin-right: 20px; margin-top: 30px;">
                                    <label for="personnel">모집인원 *</label>
                                    <input type="text" class="form-control" id="personnel" name="personnel" placeholder="모집인원" value="${noticedto.personnel}">
                                </div>
						</div>
                </div>
					<div class="col-sm-6 col-lg-6 mb-3">
						...
						<div class="row">
                                <div style="width: 30%; margin-left: 20px; margin-right: 15px;">
                                    ...
                                    <input type="date" class="form-control" id="period_start" name="period_start" placeholder="시작" value="${noticedto.period_start}">
                                </div>
                                ...
                                <div style="width: 30%; margin-left: 2px; margin-right: 20px;">
                                    ...
                                    <input type="date" class="form-control" id="period_end" name="period_end" placeholder="종료" value="${noticedto.period_end}">
                                </div>
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div>
								...
								<label for="qualification">지원자격을 작성해주세요.</label>
									<c:forEach items="${qual}" var="li" varStatus="status">
										<input type="text" class="form-control" id="qualification" name="qualification"
										style="margin-bottom: 5px;" placeholder="지원자격" value="${li}">
									</c:forEach>
							...
							<div>
								...
								<label for="preference">우대사항을 작성해주세요.</label>
									<c:forEach items="${pref}" var="li" varStatus="status">
										<input type="text" class="form-control" id="preference" name="preference"
										style="margin-bottom: 5px;" placeholder="우대사항" value="${li}">
									</c:forEach>
					...
					<div class="col-sm-6 col-lg-6 mb-3">
						...
						<div class="row">
								...
								<label for="task">업무내용을 작성해주세요.</label>
									<c:forEach items="${task}" var="li" varStatus="status">
										<input type="text" class="form-control" id="task" name="task"
										style="margin-bottom: 5px;" placeholder="업무내용" value="${li}">
									</c:forEach>
